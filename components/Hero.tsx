...
export function Hero() {
	return (
		<section className="container my-10 md:my-12">
			...
			{/* Title + description */}
			<h1 className="mt-4 text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-ink">
				...
				<div className="relative">
					...
					<div className="absolute inset-x-0 bottom-0 px-4 pb-4 md:px-6 md:pb-6">
						<div className="max-w-5xl text-white drop-shadow">
							...
							<div className="mt-3 flex flex-wrap items-start gap-x-5 gap-y-2 text-xs opacity-95 sm:items-center">
								...
								<div className="sm:ml-auto flex flex-wrap items-center gap-2">
									...
									<span className="rounded-full bg-white/10 px-2.5 py-1 ring-1 ring-white/20">Interviews</span>
